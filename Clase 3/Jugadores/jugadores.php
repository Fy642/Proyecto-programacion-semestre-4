<?php
    ...
    $consulta = $conn->query("SELECT * FROM `jugadores` WHERE `eliminado` = 0 ORDER BY `id` ASC ");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <tbody>
                ...
                <?php
                    while($resultado =$consulta->fetch_object()){
                        echo"<tr>
                                <td>".$resultado->id."</td>
                                <td>".$resultado->id_equipo."</td>
                                <td>".$resultado->numero."</td>
                                <td>".$resultado->nombre."</td>
                                <td>
                                    <svg width='16' height='16' viewBox='0 0 64 64' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                        <a href='borrar_Jugador.php?id=".$resultado->id."'>
                                ...
                                <td>
                                    <svg width='16' height='16' viewBox='0 0 64 64' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                        <a href='editar_Jugador.php?id=".$resultado->id."'>
