<?php
    ...
    $SQL = "SELECT * FROM jugadores WHERE id = " . $id_borrar;
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['confirmar']) && $_POST['confirmar'] == 'si') {
            $SQL = "UPDATE `jugadores` SET `eliminado`= 1 WHERE `id` = $id_borrar";
...
<html lang="en">
    ...
    <body>
        <form method="POST" action="">
            <p>Quieres borrar el jugador con el id <?php echo $id_borrar ?>?</p>
            <a href="equipos.php">
                <button>No</button>
            </a>
