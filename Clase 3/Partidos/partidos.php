<?php
    ...
    $consulta = $conn->query("SELECT * FROM `partidos` WHERE `eliminado` = 0 ORDER BY `id` ASC ");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        <table frame=void rules=rows>
            ...
            <tbody>
                <tr>
                    <td>ID</td>
                    <td>ID de<br>equipo<br>Local</td>
                    <td>ID de<br>equipo<br>Visitante</td>
                    <td>Goles de<br>equipo<br>local</td>
                    <td>Goles de<br>equipo<br>visitante</td>
                    <td>Hubo<br>penales</td>
                    <td>Penales<br>de equipo<br>local</td>
                    <td>Penales<br>de equipo<br>visitante</td>
                    <td>Fecha</td>
                    <td>Borrar</td>
                    <td>Editar</td>
                </tr>
                <?php
                    while($resultado =$consulta->fetch_object()){
                        echo"<tr>
                                <td>".$resultado->id."</td>
                                <td>".$resultado->id_local."</td>
                                <td>".$resultado->id_visitante."</td>
                                <td>".$resultado->goles_local."</td>
                                <td>".$resultado->goles_visitante."</td>
                                <td>".$resultado->penales."</td>
                                <td>".$resultado->penales_local."</td>
                                <td>".$resultado->penales_visitante."</td>
                                <td>".$resultado->fecha."</td>
                                <td>
                                    <svg width='16' height='16' viewBox='0 0 64 64' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                        <a href='borrar_Partido.php?id=".$resultado->id."'>
                                ...
                                <td>
                                    <svg width='16' height='16' viewBox='0 0 64 64' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                        <a href='editar_Partido.php?id=".$resultado->id."'>
